...
from .views import OrgListView, UserAskView, OrgHomeView, OrgHomeCourseView, OrgHomeTeacherView, OrgHomeDescView, OrgAddFavView
...
urlpatterns = [
    ...
    url(r'^add_fav/$', OrgAddFavView.as_view(), name='org_add_fav'),
]
